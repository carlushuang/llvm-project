...
; GFX90A-NEXT:    s_and_saveexec_b64 s[6:7], s[4:5]
...
; GFX950-NEXT:    s_and_saveexec_b64 s[2:3], s[0:1]
...
; GFX90A-NEXT:    s_and_saveexec_b64 s[8:9], s[4:5]
; GFX90A-NEXT:    ; divergent control-flow edge
...
; GFX950-NEXT:    s_xor_b64 s[0:1], vcc, exec
; GFX950-NEXT:    s_and_saveexec_b64 s[4:5], s[0:1]
; GFX950-NEXT:    ; divergent control-flow edge
