...
; GFX7-NEXT:    s_xor_b64 s[14:15], s[8:9], exec
...
; GFX7-NEXT:    s_and_b64 s[4:5], s[10:11], s[10:11]
...
; GFX89-NEXT:    s_wqm_b64 s[10:11], -1
; GFX89-NEXT:    s_xor_b64 s[8:9], vcc, exec
; GFX89-NEXT:    ; implicit-def: $vgpr0
; GFX89-NEXT:    s_mov_b64 exec, s[8:9]
...
; GFX89-NEXT:    v_cmp_ne_u32_e64 s[8:9], 0, v0
; GFX89-NEXT:    s_xor_b64 s[14:15], s[8:9], exec
...
; GFX89-NEXT:    s_and_b64 s[4:5], s[10:11], s[10:11]
...
; GFX1064-NEXT:    s_wqm_b64 s[10:11], -1
...
; GFX1064-NEXT:    s_xor_b64 s[14:15], s[8:9], exec
...
; GFX1064-NEXT:    s_and_b64 s[4:5], s[10:11], s[10:11]
...
; GFX1032-NEXT:    v_cmp_ne_u32_e64 s8, 0, v0
; GFX1032-NEXT:    s_xor_b32 s11, s8, exec_lo
...
; GFX1032-NEXT:    s_and_b32 s4, s9, s9
...
; GFX1164-NEXT:    s_wqm_b64 s[10:11], -1
...
; GFX1164-NEXT:    v_cmp_ne_u32_e64 s[8:9], 0, v0
; GFX1164-NEXT:    s_xor_b64 s[14:15], s[8:9], exec
...
; GFX1164-NEXT:    s_and_b64 s[4:5], s[10:11], s[10:11]
...
; GFX1132-NEXT:    v_cmp_ne_u32_e64 s8, 0, v0
; GFX1132-NEXT:    s_xor_b32 s11, s8, exec_lo
...
; GFX1132-NEXT:    s_and_b32 s4, s9, s9
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX8-NEXT:    v_cmp_ne_u32_e64 s[8:9], 1, v3
; GFX8-NEXT:    s_wqm_b64 s[10:11], -1
; GFX8-NEXT:    s_xor_b64 s[12:13], s[8:9], exec
...
; GFX8-NEXT:    s_and_b64 s[4:5], s[10:11], s[10:11]
...
; GFX9-NEXT:    s_or_saveexec_b64 s[8:9], -1
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, v0, s[8:9]
; GFX9-NEXT:    s_nop 1
...
; GFX9-NEXT:    s_and_b64 s[4:5], s[10:11], s[10:11]
...
; GFX1064-NEXT:  .LBB1_1:
; GFX1064-NEXT:    s_or_saveexec_b64 s[8:9], -1
; GFX1064-NEXT:    v_cndmask_b32_e64 v1, 0, v0, s[8:9]
...
; GFX1064-NEXT:    s_mov_b64 exec, s[14:15]
; GFX1064-NEXT:    ; implicit-def: $vgpr0
; GFX1064-NEXT:    s_xor_b64 exec, s[8:9], exec
; GFX1064-NEXT:    ; divergent control-flow edge
...
; GFX1032-NEXT:  .LBB1_1:
; GFX1032-NEXT:    s_or_saveexec_b32 s8, -1
; GFX1032-NEXT:    v_cndmask_b32_e64 v1, 0, v0, s8
...
; GFX1032-NEXT:    ; implicit-def: $vgpr0
; GFX1032-NEXT:    s_xor_b32 exec_lo, s8, exec_lo
; GFX1032-NEXT:    ; divergent control-flow edge
...
; GFX1164-NEXT:  .LBB1_1:
; GFX1164-NEXT:    s_or_saveexec_b64 s[8:9], -1
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1164-NEXT:    v_cndmask_b32_e64 v1, 0, v0, s[8:9]
...
; GFX1164-NEXT:    ; implicit-def: $vgpr0
; GFX1164-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1164-NEXT:    s_xor_b64 exec, s[8:9], exec
; GFX1164-NEXT:    ; divergent control-flow edge
...
; GFX1132-NEXT:    ; implicit-def: $vgpr0
; GFX1132-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX1132-NEXT:    s_xor_b32 exec_lo, s8, exec_lo
; GFX1132-NEXT:    ; divergent control-flow edge
