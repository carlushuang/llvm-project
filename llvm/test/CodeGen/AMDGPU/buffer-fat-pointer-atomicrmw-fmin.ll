...
; GFX11-NEXT:    s_and_b32 s0, s2, exec_lo
...
; GFX10-NEXT:    buffer_gl1_inv
; GFX10-NEXT:    buffer_gl0_inv
; GFX10-NEXT:    v_cmp_ne_u64_e32 vcc_lo, v[0:1], v[4:5]
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1
; GFX90A-NEXT:    v_cmp_ne_u64_e32 vcc, v[0:1], v[4:5]
; GFX90A-NEXT:    s_xor_b64 s[6:7], exec, vcc
; GFX90A-NEXT:    v_pk_mov_b32 v[4:5], v[0:1], v[0:1] op_sel:[0,1]
; GFX90A-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; GFX90A-NEXT:    s_mov_b64 exec, vcc
...
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:    v_cmp_ne_u64_e32 vcc, v[0:1], v[4:5]
...
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    buffer_wbinvl1
; GFX6-NEXT:    v_cmp_ne_u64_e32 vcc, v[0:1], v[4:5]
...
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v7, v6
...
; GFX11-TRUE16-NEXT:    s_mov_b32 exec_lo, s5
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v7, v6
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v0, v5
; GFX12-NEXT:    s_xor_b32 s5, exec_lo, vcc_lo
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_or_b32 s4, s4, s5
; GFX12-NEXT:    s_mov_b32 exec_lo, vcc_lo
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v4, v1
...
; GFX12-NEXT:    s_mov_b32 exec_lo, s5
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v5, v7
...
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v0, v6
; GFX12-TRUE16-NEXT:    s_xor_b32 s5, exec_lo, vcc_lo
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v0, v6
; GFX12-FAKE16-NEXT:    s_xor_b32 s4, exec_lo, vcc_lo
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX7-NEXT:    v_alignbit_b32 v5, v5, v3, 16
; GFX7-NEXT:    v_mov_b32_e32 v3, v4
; GFX7-NEXT:    v_mov_b32_e32 v4, v5
; GFX7-NEXT:    buffer_atomic_cmpswap v[3:4], v2, s[16:19], 0 offen offset:1024 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
; GFX7-NEXT:    v_cmp_ne_u32_e32 vcc, v3, v5
; GFX7-NEXT:    s_xor_b64 s[6:7], exec, vcc
...
; GFX6-NEXT:    v_alignbit_b32 v5, v5, v3, 16
; GFX6-NEXT:    v_mov_b32_e32 v3, v4
; GFX6-NEXT:    v_mov_b32_e32 v4, v5
; GFX6-NEXT:    buffer_atomic_cmpswap v[3:4], v2, s[16:19], 0 offen glc
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    buffer_wbinvl1
; GFX6-NEXT:    v_cmp_ne_u32_e32 vcc, v3, v5
; GFX6-NEXT:    s_xor_b64 s[6:7], exec, vcc
; GFX6-NEXT:    s_waitcnt expcnt(0)
...
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v5, v1
...
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v5, v1
; GFX12-FAKE16-NEXT:    v_mov_b32_e32 v1, v5
; GFX12-FAKE16-NEXT:    s_xor_b32 s5, exec_lo, vcc_lo
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
...
; GFX12-TRUE16-NEXT:    s_mov_b32 exec_lo, s5
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v5, v7
...
; GFX12-FAKE16-NEXT:    s_mov_b32 exec_lo, s5
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, v5, v7
...
; GFX942-NEXT:  .LBB21_6: ; %atomicrmw.end
; GFX942-NEXT:    s_or_b64 exec, exec, s[2:3]
; GFX942-NEXT:    v_mov_b32_e32 v0, v6
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:  .LBB21_6: ; %atomicrmw.end
; GFX90A-NEXT:    s_or_b64 exec, exec, s[6:7]
; GFX90A-NEXT:    v_mov_b32_e32 v0, v6
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
