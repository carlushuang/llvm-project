...
; GCN-NPM-ISEL-NEXT:   [[PHI1:%[0-9]+]]:sreg_64_xexec = PHI [[S_MOV_B64_]], %bb.0, %35, %bb.3
; GCN-NPM-ISEL-NEXT:   [[V_CNDMASK_B32_e64_:%[0-9]+]]:vgpr_32 = V_CNDMASK_B32_e64 0, 0, 0, 1, [[PHI1]], implicit $exec
; GCN-NPM-ISEL-NEXT:   [[S_MOV_B32_0:%[0-9]+]]:sreg_32 = S_MOV_B32 1
; GCN-NPM-ISEL-NEXT:   [[TMP:%[0-9]+]]:sreg_32 = COPY [[V_CNDMASK_B32_e64_]]
; GCN-NPM-ISEL-NEXT:   S_CMP_LG_U32 killed [[TMP]], killed [[S_MOV_B32_0]], implicit-def $scc
; GCN-NPM-ISEL-NEXT:   S_CBRANCH_SCC1 %bb.4, implicit $scc
; GCN-NPM-ISEL-NEXT:   S_BRANCH %bb.2
; GCN-NPM-ISEL-NEXT: {{  $}}
...
; GCN-ISEL-NEXT:   [[S_ADDC_U32_1:%[0-9]+]]:sreg_32 = S_ADDC_U32 killed [[COPY35]], [[S_MOV_B32_9]], implicit-def dead $scc, implicit $scc
...
; GCN-ISEL-NEXT:   [[REG_SEQUENCE12:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[V_MUL_HI_U32_e64_11]], %subreg.sub0, [[S_MOV_B32_8]], %subreg.sub1
...
; GCN-ISEL-NEXT:   [[S_ADDC_U32_3:%[0-9]+]]:sreg_32 = S_ADDC_U32 killed [[COPY52]], [[S_MOV_B32_9]], implicit-def dead $scc, implicit $scc
...
; GCN-ISEL-NEXT:   [[REG_SEQUENCE15:%[0-9]+]]:sreg_64 = REG_SEQUENCE killed [[COPY53]], %subreg.sub0, [[S_MOV_B32_9]], %subreg.sub1
...
; GCN-ISEL-NEXT:   [[S_ADDC_U32_5:%[0-9]+]]:sreg_32 = S_ADDC_U32 killed [[COPY66]], [[S_MOV_B32_9]], implicit-def dead $scc, implicit $scc
...
; GCN-NPM-ISEL-NEXT:   [[COPY79:%[0-9]+]]:sreg_64 = COPY [[REG_SEQUENCE23]]
