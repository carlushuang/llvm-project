...
; SDAG-NEXT:    v_cmp_lt_u64_e32 vcc, s[12:13], v[8:9]
...
; SDAG-NEXT:    v_sub_i32_e32 v22, vcc, s14, v8
...
; SDAG-NEXT:    s_and_b64 s[14:15], exec, vcc
; SDAG-NEXT:    s_xor_b64 exec, s[14:15], exec
; SDAG-NEXT:    ; divergent control-flow edge
...
; SDAG-NEXT:    v_sub_i32_e64 v18, s[4:5], v18, v21
; SDAG-NEXT:    v_subb_u32_e64 v19, s[4:5], v19, v20, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v22, s[4:5], v22, v39, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v23, s[4:5], v23, v38, s[4:5]
...
; SDAG-NEXT:    s_or_b64 s[14:15], s[14:15], s[16:17]
; SDAG-NEXT:    s_mov_b64 exec, s[4:5]
; SDAG-NEXT:    ; divergent control-flow edge
...
; SDAG-NEXT:    v_xor_b32_e32 v7, v7, v18
; SDAG-NEXT:    v_xor_b32_e32 v6, v6, v18
...
; SDAG-NEXT:    v_subb_u32_e32 v6, vcc, v6, v18, vcc
...
; SDAG-NEXT:    v_ffbh_u32_e32 v13, v29
; SDAG-NEXT:    v_ffbh_u32_e32 v14, v4
; SDAG-NEXT:    v_ffbh_u32_e32 v15, v5
; SDAG-NEXT:    v_or_b32_e32 v9, v29, v3
; SDAG-NEXT:    v_or_b32_e32 v8, v28, v2
...
; SDAG-NEXT:    v_cndmask_b32_e64 v9, v13, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v10, v11, v10, vcc
; SDAG-NEXT:    v_sub_i32_e32 v8, vcc, v8, v10
; SDAG-NEXT:    v_subb_u32_e32 v9, vcc, v12, v9, vcc
; SDAG-NEXT:    v_subb_u32_e64 v10, s[4:5], 0, 0, vcc
; SDAG-NEXT:    v_subb_u32_e64 v11, s[4:5], 0, 0, s[4:5]
; SDAG-NEXT:    v_cmp_lt_u64_e32 vcc, s[12:13], v[8:9]
...
; SDAG-NEXT:    s_or_b64 s[12:13], s[4:5], vcc
...
; SDAG-NEXT:    v_add_i32_e32 v30, vcc, 1, v8
; SDAG-NEXT:    v_addc_u32_e64 v31, s[4:5], 0, v9, vcc
; SDAG-NEXT:    v_sub_i32_e32 v16, vcc, 0x7f, v8
; SDAG-NEXT:    v_sub_i32_e32 v12, vcc, 63, v8
; SDAG-NEXT:    v_addc_u32_e64 v32, vcc, 0, v10, s[4:5]
; SDAG-NEXT:    v_addc_u32_e32 v33, vcc, 0, v11, vcc
; SDAG-NEXT:    v_lshl_b64 v[8:9], v[6:7], v16
; SDAG-NEXT:    v_sub_i32_e64 v14, s[4:5], 64, v16
; SDAG-NEXT:    v_lshl_b64 v[10:11], v[4:5], v12
; SDAG-NEXT:    v_lshl_b64 v[12:13], v[4:5], v16
; SDAG-NEXT:    v_lshr_b64 v[14:15], v[4:5], v14
; SDAG-NEXT:    v_or_b32_e32 v9, v9, v15
; SDAG-NEXT:    v_or_b32_e32 v8, v8, v14
; SDAG-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v16
; SDAG-NEXT:    v_cndmask_b32_e64 v9, v11, v9, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v8, v10, v8, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v13, 0, v13, s[4:5]
...
; SDAG-NEXT:    v_lshr_b64 v[16:17], v[6:7], v30
; SDAG-NEXT:    v_add_i32_e32 v34, vcc, -1, v28
...
; SDAG-NEXT:    v_addc_u32_e32 v35, vcc, -1, v29, vcc
; SDAG-NEXT:    v_lshl_b64 v[48:49], v[6:7], v10
...
; SDAG-NEXT:    v_addc_u32_e32 v36, vcc, -1, v2, vcc
; SDAG-NEXT:    v_or_b32_e32 v10, v38, v49
; SDAG-NEXT:    v_or_b32_e32 v38, v37, v48
; SDAG-NEXT:    v_addc_u32_e32 v37, vcc, -1, v3, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v7, v7, v10, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v6, v6, v38, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v5, v7, v5, s[6:7]
...
; SDAG-NEXT:    v_lshrrev_b32_e32 v10, 31, v13
...
; SDAG-NEXT:    v_addc_u32_e32 v32, vcc, -1, v32, vcc
; SDAG-NEXT:    v_addc_u32_e32 v33, vcc, -1, v33, vcc
; SDAG-NEXT:    v_or_b32_e32 v8, v14, v6
; SDAG-NEXT:    v_sub_i32_e32 v6, vcc, v34, v4
; SDAG-NEXT:    v_subb_u32_e32 v6, vcc, v35, v5, vcc
...
; SDAG-NEXT:    v_ashrrev_i32_e32 v6, 31, v10
; SDAG-NEXT:    v_and_b32_e32 v10, 1, v6
; SDAG-NEXT:    v_and_b32_e32 v7, v6, v29
; SDAG-NEXT:    v_and_b32_e32 v38, v6, v28
; SDAG-NEXT:    v_and_b32_e32 v39, v6, v3
; SDAG-NEXT:    v_and_b32_e32 v6, v6, v2
; SDAG-NEXT:    v_sub_i32_e64 v4, s[4:5], v4, v38
; SDAG-NEXT:    v_subb_u32_e64 v5, s[4:5], v5, v7, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v16, s[4:5], v16, v6, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v17, s[4:5], v17, v39, s[4:5]
...
; SDAG-NEXT:    v_lshl_b64 v[2:3], v[12:13], 1
; SDAG-NEXT:    v_or_b32_e32 v14, v14, v4
; SDAG-NEXT:    v_or_b32_e32 v12, v11, v3
; SDAG-NEXT:    v_or_b32_e32 v13, v10, v2
...
; SDAG-NEXT:    v_xor_b32_e32 v10, v15, v7
; SDAG-NEXT:    v_xor_b32_e32 v11, v14, v6
; SDAG-NEXT:    v_xor_b32_e32 v5, v12, v7
; SDAG-NEXT:    v_xor_b32_e32 v4, v13, v6
...
; SDAG-NEXT:    v_cmp_lt_u64_e32 vcc, s[12:13], v[20:21]
...
; SDAG-NEXT:    v_sub_i32_e32 v24, vcc, s14, v20
...
; SDAG-NEXT:    v_cndmask_b32_e64 v1, 0, v11, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, v10, s[4:5]
...
; SDAG-NEXT:    v_sub_i32_e64 v6, s[4:5], v6, v4
; SDAG-NEXT:    v_subb_u32_e64 v7, s[4:5], v7, v31, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v20, s[4:5], v20, v30, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v21, s[4:5], v21, v5, s[4:5]
; SDAG-NEXT:    v_mov_b32_e32 v4, v16
; SDAG-NEXT:    v_mov_b32_e32 v5, v17
; SDAG-NEXT:    s_xor_b64 s[4:5], vcc, exec
; SDAG-NEXT:    s_xor_b64 s[10:11], exec, s[4:5]
; SDAG-NEXT:    s_or_b64 s[8:9], s[8:9], s[10:11]
; SDAG-NEXT:    s_mov_b64 exec, s[4:5]
; SDAG-NEXT:    ; divergent control-flow edge
...
; SDAG-NEXT:    v_cmp_lt_u64_e32 vcc, s[12:13], v[16:17]
; SDAG-NEXT:    v_cndmask_b32_e64 v20, 0, 1, vcc
...
; SDAG-NEXT:    v_cndmask_b32_e64 v36, v0, 0, s[4:5]
; SDAG-NEXT:    s_xor_b64 s[4:5], s[6:7], exec
; SDAG-NEXT:    s_mov_b64 s[10:11], -1
; SDAG-NEXT:    s_mov_b64 s[8:9], 0
; SDAG-NEXT:    s_mov_b64 s[8:9], 0
...
; SDAG-NEXT:    v_sub_i32_e32 v22, vcc, s14, v16
...
; SDAG-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v22
; SDAG-NEXT:    v_cndmask_b32_e64 v11, v17, v11, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v10, v16, v10, s[4:5]
...
; SDAG-NEXT:    v_sub_i32_e64 v24, s[4:5], v24, v23
; SDAG-NEXT:    v_subb_u32_e64 v25, s[4:5], v25, v22, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v26, s[4:5], v26, v49, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v27, s[4:5], v27, v48, s[4:5]
...
; SDAG-NEXT:    v_subb_u32_e64 v35, s[4:5], v13, v16, s[4:5]
...
; SDAG-NEXT:    v_ffbh_u32_e32 v19, v35
; SDAG-NEXT:    v_ffbh_u32_e32 v20, v4
; SDAG-NEXT:    v_ffbh_u32_e32 v21, v5
; SDAG-NEXT:    v_or_b32_e32 v15, v35, v13
...
; SDAG-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v22
; SDAG-NEXT:    v_cndmask_b32_e64 v17, v17, v15, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v16, v16, v14, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v15, 0, v19, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v14, 0, v18, s[4:5]
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v22
; SDAG-NEXT:    v_cndmask_b32_e64 v19, v17, v7, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v18, v16, v6, s[4:5]
; SDAG-NEXT:    v_mov_b32_e32 v16, 0
; SDAG-NEXT:    v_mov_b32_e32 v17, 0
; SDAG-NEXT:    s_and_b64 s[4:5], exec, vcc
; SDAG-NEXT:    s_xor_b64 s[12:13], s[4:5], exec
...
; SDAG-NEXT:    v_and_b32_e32 v55, v22, v35
; SDAG-NEXT:    v_and_b32_e32 v22, v22, v37
; SDAG-NEXT:    v_sub_i32_e64 v24, s[4:5], v24, v22
; SDAG-NEXT:    v_subb_u32_e64 v25, s[4:5], v25, v55, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v26, s[4:5], v26, v54, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v27, s[4:5], v27, v23, s[4:5]
; SDAG-NEXT:    v_mov_b32_e32 v23, v17
; SDAG-NEXT:    v_mov_b32_e32 v22, v16
; SDAG-NEXT:    s_xor_b64 s[4:5], vcc, exec
; SDAG-NEXT:    s_xor_b64 s[10:11], exec, s[4:5]
...
; SDAG-NEXT:    s_or_b64 exec, exec, s[6:7]
; SDAG-NEXT:    v_mul_lo_u32 v17, v36, v9
; SDAG-NEXT:    v_mad_u64_u32 v[22:23], s[4:5], v36, v8, 0
; SDAG-NEXT:    v_mul_lo_u32 v24, v34, v8
; SDAG-NEXT:    v_mul_lo_u32 v26, v11, v31
; SDAG-NEXT:    v_mul_lo_u32 v27, v10, v30
; SDAG-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v31, v36, 0
; SDAG-NEXT:    v_mov_b32_e32 v16, 0
...
; SDAG-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v30, v34, v[12:13]
; SDAG-NEXT:    v_xor_b32_e32 v1, v1, v29
; SDAG-NEXT:    v_add_i32_e64 v9, s[4:5], v19, v9
; SDAG-NEXT:    v_mad_u64_u32 v[17:18], s[4:5], v35, v21, v[15:16]
...
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[8:9], v35, v20, v[9:10]
...
; SDAG-NEXT:    v_sub_i32_e32 v24, vcc, s14, v18
...
; SDAG-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v24
; SDAG-NEXT:    v_cndmask_b32_e64 v17, v19, v17, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v16, v18, v16, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v21, 0, v21, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v20, 0, v20, s[4:5]
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v24
...
; SDAG-NEXT:    v_sub_i32_e64 v26, s[4:5], v26, v25
; SDAG-NEXT:    v_subb_u32_e64 v27, s[4:5], v27, v24, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v28, s[4:5], v28, v39, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v29, s[4:5], v29, v38, s[4:5]
...
; SDAG-NEXT:    v_sub_i32_e32 v26, vcc, 0x7f, v20
...
; SDAG-NEXT:    v_sub_i32_e64 v26, s[4:5], v26, v50
; SDAG-NEXT:    v_subb_u32_e64 v27, s[4:5], v27, v29, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v30, s[4:5], v30, v28, s[4:5]
; SDAG-NEXT:    v_subb_u32_e64 v31, s[4:5], v31, v51, s[4:5]
