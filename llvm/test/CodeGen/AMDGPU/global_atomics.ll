...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -amdgpu-atomic-optimizer-strategy=None < %s | FileCheck -enable-var-scope -check-prefixes=SI %s
...
; SI-NEXT:    s_lshl_b32 s5, s3, 3
; SI-NEXT:    s_load_dword s9, s[0:1], 0x0
; SI-NEXT:    s_lshl_b32 s6, 0xffff, s5
