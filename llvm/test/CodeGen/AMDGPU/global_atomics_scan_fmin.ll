...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -amdgpu-atomic-optimizer-strategy=Iterative < %s | FileCheck -enable-var-scope -check-prefix=GFX7LESS %s
...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefix=GFX7LESS-DPP %s
...
; GFX7LESS-NEXT:    v_mul_f32_e64 v2, 1.0, s8
...
; GFX7LESS-DPP-NEXT:  .LBB7_2: ; %atomicrmw.end
; GFX7LESS-DPP-NEXT:    s_endpgm
;
...
; GFX7LESS-DPP-NEXT:  .LBB9_2: ; %atomicrmw.end
; GFX7LESS-DPP-NEXT:    s_endpgm
;
...
; GFX7LESS-DPP-NEXT:  .LBB11_2: ; %atomicrmw.end
; GFX7LESS-DPP-NEXT:    s_endpgm
;
