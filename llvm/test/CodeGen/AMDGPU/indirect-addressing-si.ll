...
; RUN: llc -amdgpu-late-wave-transform=1 -mtriple=amdgcn < %s | FileCheck -check-prefix=GENERIC %s
...
; GENERIC-NEXT:    s_load_dword s22, s[4:5], 0x39
; GENERIC-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GENERIC-NEXT:    s_mov_b32 s3, 0xf000
; GENERIC-NEXT:    s_mov_b32 s2, -1
; GENERIC-NEXT:    s_waitcnt lgkmcnt(0)
; GENERIC-NEXT:    s_addk_i32 s22, 0xfe00
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 1
; GENERIC-NEXT:    s_cselect_b32 s4, s9, s8
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 2
; GENERIC-NEXT:    s_cselect_b32 s4, s10, s4
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 3
; GENERIC-NEXT:    s_cselect_b32 s4, s11, s4
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 4
; GENERIC-NEXT:    s_cselect_b32 s4, s12, s4
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 5
; GENERIC-NEXT:    s_cselect_b32 s4, s13, s4
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 6
; GENERIC-NEXT:    s_cselect_b32 s4, s14, s4
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 7
; GENERIC-NEXT:    s_cselect_b32 s4, s15, s4
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 8
; GENERIC-NEXT:    s_cselect_b32 s4, s16, s4
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 9
; GENERIC-NEXT:    s_cselect_b32 s4, s17, s4
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 10
; GENERIC-NEXT:    s_cselect_b32 s4, s18, s4
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 11
; GENERIC-NEXT:    s_cselect_b32 s4, s19, s4
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 12
; GENERIC-NEXT:    s_cselect_b32 s4, s20, s4
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 13
; GENERIC-NEXT:    s_cselect_b32 s4, s21, s4
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 14
; GENERIC-NEXT:    s_cselect_b32 s4, s7, s4
; GENERIC-NEXT:    s_cmp_eq_u32 s22, 15
...
; GENERIC-NEXT:    v_mov_b32_e32 v5, 0x41000000
...
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v4, 4.0, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 2
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v3, v1, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 1
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v2, 2.0, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 0
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v1, 1.0, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 7
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v8, v5, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 6
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v7, v6, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 5
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v6, v9, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 4
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v5, v10, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 11
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v9, v11, v0, vcc
...
; GENERIC-NEXT:    v_cndmask_b32_e32 v8, v12, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 9
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v7, v13, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 8
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v6, v14, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 15
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v10, v15, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 14
; GENERIC-NEXT:    buffer_store_dwordx4 v[6:9], off, s[0:3], 0 offset:32
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    s_waitcnt expcnt(0)
; GENERIC-NEXT:    v_cndmask_b32_e32 v9, v16, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 13
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v8, v17, v0, vcc
; GENERIC-NEXT:    s_cmp_eq_u32 s4, 12
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v7, v18, v0, vcc
...
; GENERIC-NEXT:    s_cselect_b32 s5, s11, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 2
; GENERIC-NEXT:    s_cselect_b32 s6, s10, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 1
; GENERIC-NEXT:    v_mov_b32_e32 v3, s5
; GENERIC-NEXT:    s_cselect_b32 s5, s9, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 0
; GENERIC-NEXT:    v_mov_b32_e32 v2, s6
; GENERIC-NEXT:    s_cselect_b32 s6, s8, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 7
; GENERIC-NEXT:    v_mov_b32_e32 v1, s5
; GENERIC-NEXT:    s_cselect_b32 s5, s15, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 6
; GENERIC-NEXT:    v_mov_b32_e32 v0, s6
; GENERIC-NEXT:    s_cselect_b32 s6, s14, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 5
; GENERIC-NEXT:    v_mov_b32_e32 v7, s5
; GENERIC-NEXT:    s_cselect_b32 s5, s13, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 4
; GENERIC-NEXT:    v_mov_b32_e32 v6, s6
; GENERIC-NEXT:    s_cselect_b32 s6, s12, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 11
; GENERIC-NEXT:    v_mov_b32_e32 v5, s5
; GENERIC-NEXT:    s_cselect_b32 s5, s19, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 10
; GENERIC-NEXT:    v_mov_b32_e32 v4, s6
; GENERIC-NEXT:    buffer_store_dwordx4 v[4:7], off, s[0:3], 0 offset:16
; GENERIC-NEXT:    s_cselect_b32 s6, s18, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 9
; GENERIC-NEXT:    s_waitcnt expcnt(0)
; GENERIC-NEXT:    v_mov_b32_e32 v7, s5
; GENERIC-NEXT:    s_cselect_b32 s5, s17, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 8
; GENERIC-NEXT:    v_mov_b32_e32 v6, s6
; GENERIC-NEXT:    s_cselect_b32 s6, s16, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 15
; GENERIC-NEXT:    v_mov_b32_e32 v5, s5
; GENERIC-NEXT:    s_cselect_b32 s5, s23, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 14
; GENERIC-NEXT:    v_mov_b32_e32 v4, s6
; GENERIC-NEXT:    s_cselect_b32 s6, s22, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 13
; GENERIC-NEXT:    s_cselect_b32 s7, s21, 5
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 12
; GENERIC-NEXT:    s_cselect_b32 s4, s20, 5
; GENERIC-NEXT:    buffer_store_dwordx4 v[4:7], off, s[0:3], 0 offset:32
; GENERIC-NEXT:    s_waitcnt expcnt(0)
; GENERIC-NEXT:    v_mov_b32_e32 v7, s5
; GENERIC-NEXT:    v_mov_b32_e32 v6, s6
...
; GENERIC:       ; %bb.0: ; %entry
; GENERIC-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x9
...
; GENERIC-NEXT:    s_waitcnt vmcnt(0)
; GENERIC-NEXT:    s_mov_b32 s2, -1
; GENERIC-NEXT:    s_mov_b32 s0, s6
; GENERIC-NEXT:    s_mov_b32 s1, s7
...
; GENERIC:       ; %bb.0: ; %entry
; GENERIC-NEXT:    s_load_dwordx2 s[28:29], s[4:5], 0xd
; GENERIC-NEXT:    s_load_dwordx16 s[12:27], s[4:5], 0x19
; GENERIC-NEXT:    s_mov_b32 s31, 0xf000
; GENERIC-NEXT:    s_mov_b32 s30, 0
; GENERIC-NEXT:    v_lshlrev_b32_e32 v1, 2, v0
; GENERIC-NEXT:    v_mov_b32_e32 v2, 0
; GENERIC-NEXT:    s_waitcnt lgkmcnt(0)
; GENERIC-NEXT:    buffer_load_dword v1, v[1:2], s[28:31], 0 addr64 glc
; GENERIC-NEXT:    s_waitcnt vmcnt(0)
; GENERIC-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GENERIC-NEXT:    ;;#ASMSTART
; GENERIC-NEXT:    v_mov_b32 v0, 62
; GENERIC-NEXT:    ;;#ASMEND
; GENERIC-NEXT:    v_mov_b32_e32 v14, s24
; GENERIC-NEXT:    v_mov_b32_e32 v15, s25
; GENERIC-NEXT:    v_mov_b32_e32 v10, s26
; GENERIC-NEXT:    v_mov_b32_e32 v11, s27
...
; GENERIC-NEXT:    v_cndmask_b32_e64 v12, v2, v0, s[0:1]
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[0:1], 7, v1
; GENERIC-NEXT:    v_cndmask_b32_e64 v13, v3, v0, s[0:1]
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[0:1], 0, v1
; GENERIC-NEXT:    v_cndmask_b32_e64 v2, v4, v0, s[0:1]
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[0:1], 1, v1
; GENERIC-NEXT:    v_cndmask_b32_e64 v3, v5, v0, s[0:1]
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[0:1], 2, v1
; GENERIC-NEXT:    v_cndmask_b32_e64 v4, v8, v0, s[0:1]
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[0:1], 3, v1
; GENERIC-NEXT:    v_cndmask_b32_e64 v5, v9, v0, s[0:1]
...
; GENERIC-NEXT:    v_cndmask_b32_e64 v4, 63, v4, s[0:1]
...
; GENERIC-NEXT:    v_cndmask_b32_e64 v9, 63, v13, s[0:1]
; GENERIC-NEXT:    v_cmp_ne_u32_e64 s[0:1], 6, v18
; GENERIC-NEXT:    v_cndmask_b32_e64 v8, 63, v12, s[0:1]
; GENERIC-NEXT:    v_mov_b32_e32 v12, s17
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[0:1], 12, v1
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[2:3], 13, v1
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[6:7], 14, v1
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[8:9], 15, v1
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[10:11], 8, v1
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[12:13], 9, v1
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[14:15], 11, v1
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[16:17], 4, v1
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[18:19], 5, v1
; GENERIC-NEXT:    v_mov_b32_e32 v13, s22
; GENERIC-NEXT:    v_cmp_eq_u32_e64 s[20:21], 10, v1
; GENERIC-NEXT:    v_cndmask_b32_e64 v1, v13, v0, s[20:21]
; GENERIC-NEXT:    v_cndmask_b32_e64 v13, v6, v0, s[14:15]
; GENERIC-NEXT:    v_cndmask_b32_e64 v6, v7, v0, s[16:17]
; GENERIC-NEXT:    v_cndmask_b32_e64 v7, v12, v0, s[18:19]
; GENERIC-NEXT:    v_cmp_ne_u32_e64 s[14:15], 5, v18
; GENERIC-NEXT:    v_cndmask_b32_e64 v7, 63, v7, s[14:15]
; GENERIC-NEXT:    v_cmp_ne_u32_e64 s[14:15], 4, v18
; GENERIC-NEXT:    v_cndmask_b32_e64 v6, 63, v6, s[14:15]
; GENERIC-NEXT:    v_cmp_ne_u32_e64 s[14:15], 10, v18
; GENERIC-NEXT:    v_cmp_ne_u32_e64 s[16:17], 11, v18
; GENERIC-NEXT:    v_cndmask_b32_e64 v13, 63, v13, s[16:17]
; GENERIC-NEXT:    v_cndmask_b32_e64 v12, 63, v1, s[14:15]
; GENERIC-NEXT:    s_load_dwordx2 s[28:29], s[4:5], 0x9
; GENERIC-NEXT:    s_mov_b32 s30, -1
; GENERIC-NEXT:    v_cndmask_b32_e64 v1, v10, v0, s[6:7]
; GENERIC-NEXT:    v_cndmask_b32_e64 v19, v11, v0, s[8:9]
; GENERIC-NEXT:    v_cndmask_b32_e64 v10, v16, v0, s[10:11]
; GENERIC-NEXT:    v_cndmask_b32_e64 v11, v17, v0, s[12:13]
; GENERIC-NEXT:    v_cmp_ne_u32_e64 s[4:5], 9, v18
; GENERIC-NEXT:    v_cndmask_b32_e64 v11, 63, v11, s[4:5]
; GENERIC-NEXT:    v_cmp_ne_u32_e64 s[4:5], 8, v18
; GENERIC-NEXT:    v_cndmask_b32_e64 v10, 63, v10, s[4:5]
; GENERIC-NEXT:    v_cmp_ne_u32_e64 s[4:5], 14, v18
; GENERIC-NEXT:    v_cmp_ne_u32_e64 s[6:7], 15, v18
; GENERIC-NEXT:    v_cndmask_b32_e64 v17, 63, v19, s[6:7]
; GENERIC-NEXT:    v_cndmask_b32_e64 v16, 63, v1, s[4:5]
; GENERIC-NEXT:    v_cndmask_b32_e64 v1, v14, v0, s[0:1]
; GENERIC-NEXT:    v_cndmask_b32_e64 v14, v15, v0, s[2:3]
...
; GENERIC-NEXT:    v_cndmask_b32_e64 v14, 63, v1, s[0:1]
; GENERIC-NEXT:    s_waitcnt lgkmcnt(0)
; GENERIC-NEXT:    buffer_store_dwordx4 v[14:17], off, s[28:31], 0 offset:48
; GENERIC-NEXT:    s_waitcnt vmcnt(0)
; GENERIC-NEXT:    buffer_store_dwordx4 v[10:13], off, s[28:31], 0 offset:32
; GENERIC-NEXT:    s_waitcnt vmcnt(0)
; GENERIC-NEXT:    buffer_store_dwordx4 v[6:9], off, s[28:31], 0 offset:16
; GENERIC-NEXT:    s_waitcnt vmcnt(0)
; GENERIC-NEXT:    buffer_store_dwordx4 v[2:5], off, s[28:31], 0
; GENERIC-NEXT:    s_waitcnt vmcnt(0)
; GENERIC-NEXT:    s_xor_b64 exec, vcc, exec
; GENERIC-NEXT:    ; divergent control-flow edge
...
; GENERIC-NEXT:    buffer_store_dword v0, off, s[28:31], 0
; GENERIC-NEXT:    s_waitcnt vmcnt(0)
; GENERIC-NEXT:    s_endpgm
;
...
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 1
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v2, v0, v5, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 0
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v1, v0, v6, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 7
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v8, v0, v7, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 6
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v7, v0, v9, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 5
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v6, v0, v10, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 4
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v5, v0, v11, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 11
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v9, v0, v12, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 10
; GENERIC-NEXT:    buffer_store_dwordx4 v[5:8], off, s[0:3], 0 offset:16
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    s_waitcnt expcnt(0)
; GENERIC-NEXT:    v_cndmask_b32_e32 v8, v0, v13, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 9
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v7, v0, v14, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 8
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v6, v0, v15, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 15
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v10, v0, v16, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 14
; GENERIC-NEXT:    buffer_store_dwordx4 v[6:9], off, s[0:3], 0 offset:32
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    s_waitcnt expcnt(0)
; GENERIC-NEXT:    v_cndmask_b32_e32 v9, v0, v17, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 13
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v8, v0, v18, vcc
; GENERIC-NEXT:    s_cmp_lg_u32 s4, 12
; GENERIC-NEXT:    s_cselect_b64 vcc, -1, 0
; GENERIC-NEXT:    v_cndmask_b32_e32 v7, v0, v19, vcc
; GENERIC-NEXT:    buffer_store_dwordx4 v[7:10], off, s[0:3], 0 offset:48
; GENERIC-NEXT:    buffer_store_dwordx4 v[1:4], off, s[0:3], 0
; GENERIC-NEXT:    s_endpgm
;
...
; GENERIC-NEXT:    s_cbranch_scc1 .LBB26_2
...
; GENERIC-NEXT:    s_cmp_ge_i32 s4, s0
; GENERIC-NEXT:    s_cbranch_scc0 .LBB26_1
; GENERIC-NEXT:  .LBB26_2: ; %bb8
; GENERIC-NEXT:    s_endpgm
;
