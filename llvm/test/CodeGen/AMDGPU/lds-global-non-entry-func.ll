...
; GFX8-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GFX8-SDAG-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX8-SDAG-NEXT:    s_mov_b32 m0, -1
; GFX8-SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
; GFX8-SDAG-NEXT:    s_mov_b64 exec, s[6:7]
...
; GFX8-SDAG-NEXT:    s_and_b64 s[4:5], s[4:5], exec
...
; GFX8-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v3
; GFX8-SDAG-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX8-SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
; GFX8-SDAG-NEXT:    s_mov_b64 exec, s[6:7]
; GFX8-SDAG-NEXT:    ; divergent control-flow edge
...
; GFX9-SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v3
; GFX9-SDAG-NEXT:    s_xor_b64 s[6:7], vcc, exec
; GFX9-SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
; GFX9-SDAG-NEXT:    s_mov_b64 exec, s[6:7]
; GFX9-SDAG-NEXT:    ; divergent control-flow edge
...
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v3
