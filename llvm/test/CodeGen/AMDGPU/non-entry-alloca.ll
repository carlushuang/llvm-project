...
; MUBUF-NEXT:    s_xor_b64 s[4:5], exec, s[6:7]
...
; MUBUF-NEXT:    s_xor_b64 s[6:7], vcc, exec
; MUBUF-NEXT:    s_xor_b64 s[8:9], exec, s[6:7]
; MUBUF-NEXT:    s_and_b64 s[8:9], s[8:9], exec
; MUBUF-NEXT:    s_or_b64 s[4:5], s[4:5], s[8:9]
; MUBUF-NEXT:    s_mov_b64 exec, s[6:7]
; MUBUF-NEXT:    ; divergent control-flow edge
; MUBUF-NEXT:    s_cbranch_execz .LBB2_3
...
; FLATSCR-NEXT:    s_xor_b64 s[0:1], exec, s[2:3]
...
; FLATSCR-NEXT:    s_xor_b64 s[2:3], vcc, exec
; FLATSCR-NEXT:    s_xor_b64 s[4:5], exec, s[2:3]
; FLATSCR-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; FLATSCR-NEXT:    s_or_b64 s[0:1], s[0:1], s[4:5]
; FLATSCR-NEXT:    s_mov_b64 exec, s[2:3]
; FLATSCR-NEXT:    ; divergent control-flow edge
; FLATSCR-NEXT:    s_cbranch_execz .LBB2_3
