...
; GFX942-NEXT:    s_mul_hi_u32 s16, s5, s14
; GFX942-NEXT:    s_mul_i32 s14, s5, s14
; GFX942-NEXT:    s_add_u32 s11, s11, s14
; GFX942-NEXT:    s_mul_hi_u32 s15, s5, s9
; GFX942-NEXT:    s_addc_u32 s10, s10, s16
; GFX942-NEXT:    s_addc_u32 s11, s15, 0
...
; GFX942-NEXT:    s_mul_i32 s9, s1, s5
; GFX942-NEXT:    s_mul_hi_u32 s10, s1, s8
; GFX942-NEXT:    s_add_i32 s9, s10, s9
; GFX942-NEXT:    s_mul_i32 s3, s3, s8
; GFX942-NEXT:    s_add_i32 s9, s9, s3
; GFX942-NEXT:    s_mul_i32 s1, s1, s8
; GFX942-NEXT:    s_mul_hi_u32 s10, s5, s1
; GFX942-NEXT:    s_mul_i32 s11, s5, s1
; GFX942-NEXT:    s_mul_i32 s15, s8, s9
; GFX942-NEXT:    s_mul_hi_u32 s1, s8, s1
...
; GFX942-NEXT:    s_mul_hi_u32 s3, s5, s9
; GFX942-NEXT:    s_addc_u32 s1, s14, s10
; GFX942-NEXT:    s_addc_u32 s3, s3, 0
; GFX942-NEXT:    s_mul_i32 s9, s5, s9
; GFX942-NEXT:    s_add_u32 s1, s1, s9
...
; GFX942-NEXT:    s_mul_hi_u32 s10, s7, s1
; GFX942-NEXT:    s_mul_i32 s1, s7, s1
; GFX942-NEXT:    s_add_u32 s1, s8, s1
; GFX942-NEXT:    s_mul_hi_u32 s9, s7, s3
; GFX942-NEXT:    s_addc_u32 s1, s5, s10
...
; GFX942-NEXT:    s_cselect_b32 s11, s14, s3
; GFX942-NEXT:    s_cselect_b32 s10, s10, s1
...
; GFX942-NEXT:    s_sub_i32 s9, s5, s12
