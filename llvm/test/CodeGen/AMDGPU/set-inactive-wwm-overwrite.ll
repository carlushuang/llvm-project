...
; GCN-NEXT:    v_cndmask_b32_e64 v0, 0, v1, s0
; GCN-NEXT:    v_mov_b32_e32 v1, 0
; GCN-NEXT:    v_mov_b32_dpp v1, v0 row_shr:1 row_mask:0xf bank_mask:0xf
; GCN-NEXT:    s_mov_b32 exec_lo, s0
; GCN-NEXT:    v_mov_b32_e32 v0, v1
; GCN-NEXT:    v_mov_b32_e32 v2, -1
; GCN-NEXT:    v_mov_b32_e32 v1, 0
; GCN-NEXT:    buffer_store_dword v2, v0, s[4:7], 0 offen
; GCN-NEXT:  .LBB0_4: ; %.end
...
; GCN-NEXT:    v_cndmask_b32_e64 v1, 0, v1, s0
; GCN-NEXT:    v_mov_b32_dpp v0, v1 row_shr:1 row_mask:0xf bank_mask:0xf
; GCN-NEXT:    s_mov_b32 exec_lo, s0
