...
; GCN-NEXT:    s_mul_i32 s8, s8, s4
; GCN-NEXT:    s_sub_i32 s7, s7, s8
; GCN-NEXT:    s_sub_i32 s8, s7, s4
; GCN-NEXT:    s_cmp_ge_u32 s7, s4
; GCN-NEXT:    v_mul_lo_u32 v0, v1, s6
; GCN-NEXT:    s_cselect_b32 s7, s8, s7
; GCN-NEXT:    s_sub_i32 s8, s7, s4
; GCN-NEXT:    s_cmp_ge_u32 s7, s4
; GCN-NEXT:    s_cselect_b32 s4, s8, s7
; GCN-NEXT:    v_sub_i32_e32 v0, vcc, s5, v0
; GCN-NEXT:    v_mov_b32_e32 v1, 0
; GCN-NEXT:    v_and_b32_e32 v2, 0x7fffff, v0
; GCN-NEXT:    v_mov_b32_e32 v0, s4
; GCN-NEXT:    v_mov_b32_e32 v3, v1
; GCN-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
; GCN-NEXT:    s_endpgm
...
; GCN-IR-NEXT:    s_sub_i32 s7, 0, s4
; GCN-IR-NEXT:    s_lshr_b32 s6, s15, 9
; GCN-IR-NEXT:    v_cvt_f32_u32_e32 v1, s6
...
; GCN-IR-NEXT:    v_mul_lo_u32 v4, s7, v0
...
; GCN-IR-NEXT:    s_mul_i32 s8, s8, s4
; GCN-IR-NEXT:    s_sub_i32 s7, s7, s8
; GCN-IR-NEXT:    s_sub_i32 s8, s7, s4
; GCN-IR-NEXT:    s_cmp_ge_u32 s7, s4
; GCN-IR-NEXT:    v_mul_lo_u32 v0, v1, s6
; GCN-IR-NEXT:    s_cselect_b32 s7, s8, s7
; GCN-IR-NEXT:    s_sub_i32 s8, s7, s4
; GCN-IR-NEXT:    s_cmp_ge_u32 s7, s4
; GCN-IR-NEXT:    s_cselect_b32 s4, s8, s7
; GCN-IR-NEXT:    v_sub_i32_e32 v0, vcc, s5, v0
; GCN-IR-NEXT:    v_mov_b32_e32 v1, 0
; GCN-IR-NEXT:    v_and_b32_e32 v2, 0x7fffff, v0
...
; GCN-NEXT:    s_mul_i32 s11, s8, s0
; GCN-NEXT:    s_mul_i32 s12, s1, s0
