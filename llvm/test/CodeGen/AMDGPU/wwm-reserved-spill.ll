...
; GFX9-O0-NEXT:    buffer_load_dwordx2 v[1:2], off, s[36:39], s34
...
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v0, v2, v0, s[40:41]
; GFX9-O0-NEXT:    ; implicit-def: $sgpr42_sgpr43
; GFX9-O0-NEXT:    v_mov_b32_e32 v2, s34
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v1, v2, v1, s[40:41]
; GFX9-O0-NEXT:    v_mov_b32_e32 v2, s34
...
; GFX9-O0-NEXT:    s_mov_b64 exec, s[40:41]
; GFX9-O0-NEXT:    v_mov_b32_e32 v1, v2
; GFX9-O0-NEXT:    v_cmp_eq_u32_e64 s[40:41], v0, v1
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[40:41]
; GFX9-O0-NEXT:    s_mov_b32 s35, 1
; GFX9-O0-NEXT:    v_lshlrev_b32_e64 v0, s35, v0
; GFX9-O0-NEXT:    s_mov_b32 s35, 2
; GFX9-O0-NEXT:    v_and_b32_e64 v0, v0, s35
...
; GFX9-O3-NEXT:    buffer_load_dwordx2 v[0:1], off, s[4:7], 0
...
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v0, 0, v0, s[34:35]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v1, 0, v1, s[34:35]
...
; GFX9-O0-NEXT:    v_writelane_b32 v3, s36, 0
; GFX9-O0-NEXT:    v_writelane_b32 v3, s37, 1
; GFX9-O0-NEXT:    v_writelane_b32 v3, s34, 2
; GFX9-O0-NEXT:    v_writelane_b32 v3, s35, 3
; GFX9-O0-NEXT:    s_mov_b32 s36, 0
; GFX9-O0-NEXT:    s_nop 0
; GFX9-O0-NEXT:    buffer_load_dwordx2 v[1:2], off, s[40:43], s36
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v1, v2, v1, s[34:35]
; GFX9-O0-NEXT:    v_mov_b32_e32 v2, s36
; GFX9-O0-NEXT:    s_nop 1
; GFX9-O0-NEXT:    v_mov_b32_dpp v2, v1 row_bcast:31 row_mask:0xc bank_mask:0xf
; GFX9-O0-NEXT:    v_add_u32_e64 v2, v1, v2
...
; GFX9-O0-NEXT:    v_writelane_b32 v3, s36, 4
; GFX9-O0-NEXT:    v_writelane_b32 v3, s37, 5
...
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v0, v1, v0, s[34:35]
; GFX9-O0-NEXT:    s_nop 1
...
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_cmp_eq_u32_e64 s[36:37], v0, v1
...
; GFX9-O3:       ; %bb.0: ; %entry
; GFX9-O3-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-O3-NEXT:    buffer_load_dwordx2 v[1:2], off, s[4:7], 0
; GFX9-O3-NEXT:    v_mov_b32_e32 v3, 0
; GFX9-O3-NEXT:    s_or_saveexec_b64 s[34:35], -1
...
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v2, 0, v2, s[34:35]
; GFX9-O3-NEXT:    s_nop 1
...
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v0, v1, v0, s[40:41]
; GFX9-O0-NEXT:    s_mov_b64 exec, s[40:41]
...
; GFX9-O3-NEXT:    v_add_u32_e32 v0, v0, v2
; GFX9-O3-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O3-NEXT:    v_mov_b32_e32 v1, v0
; GFX9-O3-NEXT:    v_readlane_b32 s30, v3, 0
; GFX9-O3-NEXT:    buffer_store_dword v1, off, s[4:7], 0 offset:4
...
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v0, v1, v0, s[38:39]
...
; GFX9-O0-NEXT:    buffer_load_dword v4, off, s[0:3], s33 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    buffer_load_dword v5, off, s[0:3], s33 offset:4 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    v_mov_b32_e32 v2, v1
; GFX9-O0-NEXT:    ; kill: def $vgpr0 killed $vgpr0 def $vgpr0_vgpr1 killed $exec
; GFX9-O0-NEXT:    v_mov_b32_e32 v1, v2
; GFX9-O0-NEXT:    v_mov_b32_e32 v2, v0
...
; GFX9-O0-NEXT:    v_add_co_u32_e64 v2, s[40:41], v2, v3
; GFX9-O0-NEXT:    v_addc_co_u32_e64 v0, s[40:41], v0, v1, s[40:41]
; GFX9-O0-NEXT:    ; kill: def $vgpr2 killed $vgpr2 def $vgpr2_vgpr3 killed $exec
...
; GFX9-O3-NEXT:    buffer_store_dwordx2 v[2:3], off, s[4:7], 0 offset:4
...
; GFX9-O0-NEXT:    v_lshlrev_b32_e64 v2, s34, v0
; GFX9-O0-NEXT:    s_mov_b32 s34, 0
; GFX9-O0-NEXT:    buffer_load_dwordx4 v[10:13], v2, s[36:39], s34 offen
; GFX9-O0-NEXT:    buffer_load_dwordx2 v[8:9], v2, s[36:39], s34 offen offset:16
; GFX9-O0-NEXT:    s_waitcnt vmcnt(1)
...
; GFX9-O0-NEXT:    v_mov_b32_e32 v4, s42
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v3, v4, v3, s[40:41]
; GFX9-O0-NEXT:    s_mov_b64 exec, s[40:41]
...
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v8, v3, v1, s[40:41]
...
; GFX9-O0-NEXT:    buffer_store_dwordx4 v[3:6], v2, s[36:39], s34 offen
; GFX9-O0-NEXT:    buffer_store_dwordx2 v[0:1], v2, s[36:39], s34 offen offset:16
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-O3-NEXT:    buffer_load_dwordx4 v[0:3], v10, s[4:7], 0 offen
; GFX9-O3-NEXT:    buffer_load_dwordx2 v[4:5], v10, s[4:7], 0 offen offset:16
; GFX9-O3-NEXT:    s_or_saveexec_b64 s[34:35], -1
; GFX9-O3-NEXT:    v_bfrev_b32_e32 v11, -2
; GFX9-O3-NEXT:    s_waitcnt vmcnt(1)
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v7, v11, v1, s[34:35]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v6, -1, v0, s[34:35]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v9, v11, v3, s[34:35]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v8, -1, v2, s[34:35]
; GFX9-O3-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v5, v11, v5, s[34:35]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v4, -1, v4, s[34:35]
; GFX9-O3-NEXT:    s_mov_b64 exec, s[34:35]
...
; GFX9-O3-NEXT:    buffer_store_dwordx4 v[0:3], v10, s[4:7], 0 offen
; GFX9-O3-NEXT:    buffer_store_dwordx2 v[6:7], v10, s[4:7], 0 offen offset:16
; GFX9-O3-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O3-NEXT:    s_setpc_b64 s[30:31]
...
; GFX9-O0-NEXT:    buffer_load_dword v32, off, s[0:3], s32 offset:20
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    buffer_store_dword v32, off, s[0:3], s32 offset:88 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    buffer_load_dword v33, off, s[0:3], s32 offset:16
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    buffer_store_dword v33, off, s[0:3], s32 offset:84 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    buffer_load_dword v34, off, s[0:3], s32 offset:12
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    buffer_store_dword v34, off, s[0:3], s32 offset:80 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    buffer_load_dword v35, off, s[0:3], s32 offset:8
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    buffer_store_dword v35, off, s[0:3], s32 offset:76 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    buffer_load_dword v36, off, s[0:3], s32 offset:4
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    buffer_store_dword v36, off, s[0:3], s32 offset:72 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    buffer_load_dword v37, off, s[0:3], s32
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    buffer_store_dword v37, off, s[0:3], s32 offset:68 ; 4-byte Folded Spill
...
; GFX9-O0-NEXT:    ; implicit-def: $sgpr40_sgpr41
; GFX9-O0-NEXT:    v_mov_b32_e32 v12, s37
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v0, v12, v0, s[34:35]
; GFX9-O0-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O0-NEXT:    ; kill: def $vgpr10 killed $vgpr10 killed $vgpr10_vgpr11 killed $exec
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[34:35], -1
; GFX9-O0-NEXT:    s_mov_b32 s36, s38
; GFX9-O0-NEXT:    ; implicit-def: $sgpr38_sgpr39
; GFX9-O0-NEXT:    v_mov_b32_e32 v11, s36
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v12, v11, v10, s[34:35]
...
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v12, v9, v8, s[34:35]
; GFX9-O0-NEXT:    ; kill: def $vgpr12 killed $vgpr12 def $vgpr12_vgpr13 killed $exec
; GFX9-O0-NEXT:    v_mov_b32_e32 v13, v0
; GFX9-O0-NEXT:    s_mov_b64 exec, s[34:35]
...
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[34:35], -1
; GFX9-O0-NEXT:    ; implicit-def: $sgpr38_sgpr39
; GFX9-O0-NEXT:    v_mov_b32_e32 v7, s36
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v12, v7, v6, s[34:35]
; GFX9-O0-NEXT:    ; kill: def $vgpr12 killed $vgpr12 def $vgpr12_vgpr13 killed $exec
; GFX9-O0-NEXT:    v_mov_b32_e32 v13, v0
; GFX9-O0-NEXT:    s_mov_b64 exec, s[34:35]
...
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[34:35], -1
; GFX9-O0-NEXT:    ; implicit-def: $sgpr38_sgpr39
; GFX9-O0-NEXT:    v_mov_b32_e32 v5, s36
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v12, v5, v4, s[34:35]
; GFX9-O0-NEXT:    ; kill: def $vgpr12 killed $vgpr12 def $vgpr12_vgpr13 killed $exec
; GFX9-O0-NEXT:    v_mov_b32_e32 v13, v0
; GFX9-O0-NEXT:    s_mov_b64 exec, s[34:35]
...
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v12, v3, v2, s[34:35]
; GFX9-O0-NEXT:    ; kill: def $vgpr12 killed $vgpr12 def $vgpr12_vgpr13 killed $exec
; GFX9-O0-NEXT:    v_mov_b32_e32 v13, v0
; GFX9-O0-NEXT:    s_mov_b64 exec, s[34:35]
...
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v1, 0, v1, s[34:35]
; GFX9-O3-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O3-NEXT:    v_mov_b32_e32 v11, v1
; GFX9-O3-NEXT:    v_mov_b32_e32 v12, v2
; GFX9-O3-NEXT:    s_or_saveexec_b64 s[34:35], -1
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v2, 0, v4, s[34:35]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v1, 0, v3, s[34:35]
; GFX9-O3-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O3-NEXT:    v_mov_b32_e32 v3, v1
; GFX9-O3-NEXT:    v_mov_b32_e32 v4, v2
; GFX9-O3-NEXT:    s_or_saveexec_b64 s[34:35], -1
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v2, 0, v6, s[34:35]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v1, 0, v5, s[34:35]
; GFX9-O3-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O3-NEXT:    v_mov_b32_e32 v5, v1
; GFX9-O3-NEXT:    v_mov_b32_e32 v6, v2
; GFX9-O3-NEXT:    s_or_saveexec_b64 s[34:35], -1
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v2, 0, v8, s[34:35]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v1, 0, v7, s[34:35]
; GFX9-O3-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O3-NEXT:    v_mov_b32_e32 v7, v1
; GFX9-O3-NEXT:    v_mov_b32_e32 v8, v2
; GFX9-O3-NEXT:    s_or_saveexec_b64 s[34:35], -1
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v2, 0, v10, s[34:35]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v1, 0, v9, s[34:35]
; GFX9-O3-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O3-NEXT:    v_mov_b32_e32 v9, v1
; GFX9-O3-NEXT:    v_mov_b32_e32 v10, v2
; GFX9-O3-NEXT:    buffer_store_dword v12, v0, s[0:3], 0 offen offset:4
; GFX9-O3-NEXT:    buffer_store_dword v11, v0, s[0:3], 0 offen
