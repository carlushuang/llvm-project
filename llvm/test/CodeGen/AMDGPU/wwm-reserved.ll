...
; GFX9-O0-NEXT:    buffer_load_dwordx2 v[1:2], off, s[0:3], s4
...
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v0, v2, v0, s[6:7]
; GFX9-O0-NEXT:    ; implicit-def: $sgpr8_sgpr9
; GFX9-O0-NEXT:    v_mov_b32_e32 v2, s4
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v1, v2, v1, s[6:7]
; GFX9-O0-NEXT:    v_mov_b32_e32 v2, s4
; GFX9-O0-NEXT:    s_nop 1
; GFX9-O0-NEXT:    v_mov_b32_dpp v2, v0 row_bcast:31 row_mask:0xc bank_mask:0xf
; GFX9-O0-NEXT:    v_add_u32_e64 v2, v0, v2
...
; GFX9-O0-NEXT:    v_add_u32_e64 v2, v1, v2
; GFX9-O0-NEXT:    s_mov_b64 exec, s[6:7]
; GFX9-O0-NEXT:    v_mov_b32_e32 v1, v2
; GFX9-O0-NEXT:    v_cmp_eq_u32_e64 s[6:7], v0, v1
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[6:7]
; GFX9-O0-NEXT:    s_mov_b32 s5, 1
; GFX9-O0-NEXT:    v_lshlrev_b32_e64 v0, s5, v0
; GFX9-O0-NEXT:    s_mov_b32 s5, 2
; GFX9-O0-NEXT:    v_and_b32_e64 v0, v0, s5
; GFX9-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s4 offset:4
; GFX9-O0-NEXT:    s_endpgm
;
; GFX9-O3-LABEL: no_cfg:
; GFX9-O3:       ; %bb.0:
; GFX9-O3-NEXT:    buffer_load_dwordx2 v[0:1], off, s[0:3], 0
...
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v0, 0, v0, s[4:5]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v1, 0, v1, s[4:5]
; GFX9-O3-NEXT:    s_nop 0
; GFX9-O3-NEXT:    v_mov_b32_dpp v3, v0 row_bcast:31 row_mask:0xc bank_mask:0xf
; GFX9-O3-NEXT:    v_mov_b32_dpp v2, v1 row_bcast:31 row_mask:0xc bank_mask:0xf
; GFX9-O3-NEXT:    v_add_u32_e32 v0, v0, v3
...
; GFX9-O3-NEXT:    v_cmp_eq_u32_e32 vcc, v2, v0
...
; GFX9-O0-NEXT:    v_writelane_b32 v3, s3, 0
; GFX9-O0-NEXT:    s_mov_b32 s4, s1
; GFX9-O0-NEXT:    v_readlane_b32 s1, v3, 0
...
; GFX9-O0-NEXT:    v_writelane_b32 v3, s2, 1
; GFX9-O0-NEXT:    v_writelane_b32 v3, s3, 2
; GFX9-O0-NEXT:    v_writelane_b32 v3, s0, 3
; GFX9-O0-NEXT:    v_writelane_b32 v3, s1, 4
; GFX9-O0-NEXT:    s_mov_b32 s2, 0
; GFX9-O0-NEXT:    s_nop 0
; GFX9-O0-NEXT:    buffer_load_dwordx2 v[1:2], off, s[4:7], s2
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    buffer_store_dword v1, off, s[16:19], 0 offset:8 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    s_nop 0
; GFX9-O0-NEXT:    buffer_store_dword v2, off, s[16:19], 0 offset:12 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GFX9-O0-NEXT:    ; implicit-def: $sgpr4_sgpr5
; GFX9-O0-NEXT:    v_mov_b32_e32 v2, s2
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v1, v2, v1, s[0:1]
; GFX9-O0-NEXT:    v_mov_b32_e32 v2, s2
; GFX9-O0-NEXT:    s_nop 1
; GFX9-O0-NEXT:    v_mov_b32_dpp v2, v1 row_bcast:31 row_mask:0xc bank_mask:0xf
; GFX9-O0-NEXT:    v_add_u32_e64 v2, v1, v2
...
; GFX9-O0-NEXT:    v_mov_b32_e32 v1, v2
; GFX9-O0-NEXT:    buffer_store_dword v1, off, s[16:19], 0 offset:4 ; 4-byte Folded Spill
...
; GFX9-O0-NEXT:    v_writelane_b32 v3, s2, 5
; GFX9-O0-NEXT:    v_writelane_b32 v3, s3, 6
...
; GFX9-O0-NEXT:    buffer_load_dword v1, off, s[16:19], 0 offset:12 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_mov_b32_e32 v0, v1
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GFX9-O0-NEXT:    v_mov_b32_e32 v1, 0
; GFX9-O0-NEXT:    ; implicit-def: $sgpr2_sgpr3
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v0, v1, v0, s[0:1]
; GFX9-O0-NEXT:    s_nop 1
; GFX9-O0-NEXT:    v_mov_b32_dpp v1, v0 row_bcast:31 row_mask:0xc bank_mask:0xf
; GFX9-O0-NEXT:    v_add_u32_e64 v1, v0, v1
; GFX9-O0-NEXT:    s_mov_b64 exec, s[0:1]
; GFX9-O0-NEXT:    v_mov_b32_e32 v0, v1
; GFX9-O0-NEXT:    buffer_store_dword v0, off, s[16:19], 0 ; 4-byte Folded Spill
...
; GFX9-O0-NEXT:    s_mov_b64 exec, s[12:13]
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_readlane_b32 s4, v3, 5
; GFX9-O0-NEXT:    v_readlane_b32 s5, v3, 6
; GFX9-O0-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX9-O0-NEXT:    v_readlane_b32 s2, v3, 1
; GFX9-O0-NEXT:    v_readlane_b32 s3, v3, 2
; GFX9-O0-NEXT:    v_readlane_b32 s0, v3, 3
; GFX9-O0-NEXT:    v_readlane_b32 s1, v3, 4
; GFX9-O0-NEXT:    buffer_load_dword v0, off, s[16:19], 0 offset:4 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    buffer_load_dword v1, off, s[16:19], 0 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_cmp_eq_u32_e64 s[4:5], v0, v1
...
; GFX9-O3-LABEL: cfg:
; GFX9-O3:       ; %bb.0: ; %entry
; GFX9-O3-NEXT:    buffer_load_dwordx2 v[1:2], off, s[0:3], 0
; GFX9-O3-NEXT:    v_mov_b32_e32 v3, 0
; GFX9-O3-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX9-O3-NEXT:    v_mov_b32_e32 v4, 0
; GFX9-O3-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v1, 0, v1, s[4:5]
; GFX9-O3-NEXT:    s_nop 1
; GFX9-O3-NEXT:    v_mov_b32_dpp v4, v1 row_bcast:31 row_mask:0xc bank_mask:0xf
; GFX9-O3-NEXT:    v_add_u32_e32 v1, v1, v4
; GFX9-O3-NEXT:    s_mov_b64 exec, s[4:5]
...
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v2, 0, v2, s[4:5]
; GFX9-O3-NEXT:    s_nop 1
...
; GFX9-O3-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v3
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GFX9-O3-NEXT:    v_lshlrev_b32_e32 v0, 1, v0
; GFX9-O3-NEXT:    v_and_b32_e32 v0, 2, v0
; GFX9-O3-NEXT:    buffer_store_dword v0, off, s[0:3], 0 offset:4
...
; GFX9-O0-NEXT:    v_writelane_b32 v5, s12, 0
; GFX9-O0-NEXT:    v_writelane_b32 v5, s13, 1
...
; GFX9-O0-NEXT:    v_readlane_b32 s2, v5, 0
; GFX9-O0-NEXT:    v_readlane_b32 s3, v5, 1
; GFX9-O0-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GFX9-O0-NEXT:    v_readlane_b32 s0, v5, 2
; GFX9-O0-NEXT:    v_readlane_b32 s1, v5, 3
...
; GFX9-O0-NEXT:    v_writelane_b32 v5, s16, 4
; GFX9-O0-NEXT:    v_writelane_b32 v5, s17, 5
; GFX9-O0-NEXT:    v_writelane_b32 v5, s18, 6
; GFX9-O0-NEXT:    v_writelane_b32 v5, s19, 7
; GFX9-O0-NEXT:    s_mov_b32 s8, 0
; GFX9-O0-NEXT:    v_writelane_b32 v5, s8, 8
; GFX9-O0-NEXT:    ; implicit-def: $sgpr16_sgpr17
; GFX9-O0-NEXT:    v_mov_b32_e32 v0, s2
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[2:3], -1
; GFX9-O0-NEXT:    v_mov_b32_e32 v4, s8
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v0, v4, v0, s[2:3]
; GFX9-O0-NEXT:    s_mov_b64 exec, s[2:3]
; GFX9-O0-NEXT:    buffer_store_dword v0, off, s[24:27], 0 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[2:3], -1
; GFX9-O0-NEXT:    v_writelane_b32 v5, s2, 9
; GFX9-O0-NEXT:    v_writelane_b32 v5, s3, 10
...
; GFX9-O0-NEXT:    v_lshlrev_b32_e64 v2, s15, v2
; GFX9-O0-NEXT:    v_or3_b32 v31, v1, v2, v3
; GFX9-O0-NEXT:    ; implicit-def: $sgpr15
; GFX9-O0-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; GFX9-O0-NEXT:    v_readlane_b32 s0, v5, 4
; GFX9-O0-NEXT:    v_readlane_b32 s1, v5, 5
; GFX9-O0-NEXT:    v_readlane_b32 s2, v5, 6
; GFX9-O0-NEXT:    v_readlane_b32 s3, v5, 7
; GFX9-O0-NEXT:    v_readlane_b32 s6, v5, 9
; GFX9-O0-NEXT:    v_readlane_b32 s7, v5, 10
; GFX9-O0-NEXT:    v_readlane_b32 s4, v5, 8
...
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v3, 0, v3, s[20:21]
; GFX9-O3-NEXT:    s_addc_u32 s9, s5, 0
; GFX9-O3-NEXT:    v_lshlrev_b32_e32 v2, 20, v2
; GFX9-O3-NEXT:    v_lshlrev_b32_e32 v1, 10, v1
...
; GFX9-O3-NEXT:    v_or3_b32 v31, v0, v1, v2
...
; GFX9-O3-NEXT:    buffer_store_dword v1, off, s[16:19], 0 offset:4
; GFX9-O3-NEXT:    s_endpgm
...
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v0, v1, v0, s[16:17]
...
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v5, v5, v1, s[2:3]
; GFX9-O0-NEXT:    ; kill: def $vgpr5 killed $vgpr5 def $vgpr5_vgpr6 killed $exec
; GFX9-O0-NEXT:    v_mov_b32_e32 v6, v0
; GFX9-O0-NEXT:    s_mov_b64 exec, s[2:3]
; GFX9-O0-NEXT:    buffer_store_dword v5, off, s[24:27], 0 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    s_nop 0
; GFX9-O0-NEXT:    buffer_store_dword v6, off, s[24:27], 0 offset:4 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[2:3], -1
; GFX9-O0-NEXT:    v_writelane_b32 v7, s2, 8
; GFX9-O0-NEXT:    v_writelane_b32 v7, s3, 9
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[20:21], -1
; GFX9-O0-NEXT:    buffer_store_dword v7, off, s[24:27], 0 offset:8 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    s_mov_b64 exec, s[20:21]
; GFX9-O0-NEXT:    v_mov_b32_e32 v0, v5
; GFX9-O0-NEXT:    s_mov_b32 s2, 32
; GFX9-O0-NEXT:    v_lshrrev_b64 v[5:6], s2, v[5:6]
...
; GFX9-O0-NEXT:    s_mov_b32 s15, 10
; GFX9-O0-NEXT:    v_lshlrev_b32_e64 v3, s15, v3
; GFX9-O0-NEXT:    v_or3_b32 v31, v2, v3, v4
; GFX9-O0-NEXT:    ; implicit-def: $sgpr15
; GFX9-O0-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-O0-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; GFX9-O0-NEXT:    s_or_saveexec_b64 s[20:21], -1
; GFX9-O0-NEXT:    buffer_load_dword v7, off, s[24:27], 0 offset:8 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_mov_b64 exec, s[20:21]
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-O0-NEXT:    v_readlane_b32 s5, v7, 9
; GFX9-O0-NEXT:    buffer_load_dword v4, off, s[24:27], 0 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    buffer_load_dword v5, off, s[24:27], 0 offset:4 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    v_mov_b32_e32 v2, v1
; GFX9-O0-NEXT:    ; kill: def $vgpr0 killed $vgpr0 def $vgpr0_vgpr1 killed $exec
; GFX9-O0-NEXT:    v_mov_b32_e32 v1, v2
; GFX9-O0-NEXT:    v_mov_b32_e32 v2, v0
...
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    v_mov_b32_e32 v1, v5
; GFX9-O0-NEXT:    v_add_co_u32_e64 v2, s[6:7], v2, v3
...
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v6, 0, v3, s[8:9]
...
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v7, 0, v3, s[20:21]
; GFX9-O3-NEXT:    v_lshlrev_b32_e32 v2, 20, v2
; GFX9-O3-NEXT:    v_lshlrev_b32_e32 v1, 10, v1
; GFX9-O3-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GFX9-O3-NEXT:    s_mov_b64 s[6:7], s[2:3]
...
; GFX9-O3-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-O3-NEXT:    s_swappc_b64 s[30:31], s[22:23]
; GFX9-O3-NEXT:    v_add_co_u32_e32 v0, vcc, v0, v7
; GFX9-O3-NEXT:    v_addc_co_u32_e32 v1, vcc, v1, v6, vcc
; GFX9-O3-NEXT:    s_mov_b64 exec, s[20:21]
; GFX9-O3-NEXT:    v_mov_b32_e32 v2, v0
; GFX9-O3-NEXT:    v_mov_b32_e32 v3, v1
; GFX9-O3-NEXT:    buffer_store_dwordx2 v[2:3], off, s[16:19], 0 offset:4
; GFX9-O3-NEXT:    s_endpgm
...
; GFX9-O0-NEXT:    v_lshlrev_b32_e64 v2, s4, v0
; GFX9-O0-NEXT:    s_mov_b32 s4, 0
; GFX9-O0-NEXT:    buffer_load_dwordx4 v[10:13], v2, s[0:3], s4 offen
; GFX9-O0-NEXT:    buffer_load_dwordx2 v[8:9], v2, s[0:3], s4 offen offset:16
; GFX9-O0-NEXT:    s_waitcnt vmcnt(1)
...
; GFX9-O0-NEXT:    v_mov_b32_e32 v4, s8
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v3, v4, v3, s[6:7]
; GFX9-O0-NEXT:    s_mov_b64 exec, s[6:7]
...
; GFX9-O0-NEXT:    v_mov_b32_e32 v1, s5
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v0, v1, v0, s[6:7]
; GFX9-O0-NEXT:    ; kill: def $vgpr0 killed $vgpr0 def $vgpr0_vgpr1 killed $exec
; GFX9-O0-NEXT:    v_mov_b32_e32 v1, v3
; GFX9-O0-NEXT:    s_mov_b64 exec, s[6:7]
; GFX9-O0-NEXT:    v_mov_b32_e32 v6, v0
...
; GFX9-O0-NEXT:    v_cndmask_b32_e64 v8, v3, v1, s[6:7]
...
; GFX9-O0-NEXT:    ; kill: def $vgpr3 killed $vgpr3 def $vgpr3_vgpr4_vgpr5_vgpr6 killed $exec
; GFX9-O0-NEXT:    v_mov_b32_e32 v4, v9
; GFX9-O0-NEXT:    v_mov_b32_e32 v5, v8
; GFX9-O0-NEXT:    v_mov_b32_e32 v6, v7
; GFX9-O0-NEXT:    buffer_store_dwordx4 v[3:6], v2, s[0:3], s4 offen
; GFX9-O0-NEXT:    buffer_store_dwordx2 v[0:1], v2, s[0:3], s4 offen offset:16
; GFX9-O0-NEXT:    s_endpgm
;
; GFX9-O3-LABEL: _amdgpu_cs_main:
; GFX9-O3:       ; %bb.0:
; GFX9-O3-NEXT:    v_lshlrev_b32_e32 v10, 5, v0
; GFX9-O3-NEXT:    buffer_load_dwordx4 v[0:3], v10, s[0:3], 0 offen
; GFX9-O3-NEXT:    buffer_load_dwordx2 v[4:5], v10, s[0:3], 0 offen offset:16
; GFX9-O3-NEXT:    s_or_saveexec_b64 s[4:5], -1
; GFX9-O3-NEXT:    v_bfrev_b32_e32 v11, -2
; GFX9-O3-NEXT:    s_waitcnt vmcnt(1)
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v7, v11, v1, s[4:5]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v6, -1, v0, s[4:5]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v9, v11, v3, s[4:5]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v8, -1, v2, s[4:5]
; GFX9-O3-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v5, v11, v5, s[4:5]
; GFX9-O3-NEXT:    v_cndmask_b32_e64 v4, -1, v4, s[4:5]
; GFX9-O3-NEXT:    s_mov_b64 exec, s[4:5]
...
; GFX9-O3-NEXT:    v_mov_b32_e32 v6, v4
; GFX9-O3-NEXT:    v_mov_b32_e32 v7, v5
; GFX9-O3-NEXT:    buffer_store_dwordx4 v[0:3], v10, s[0:3], 0 offen
; GFX9-O3-NEXT:    buffer_store_dwordx2 v[6:7], v10, s[0:3], 0 offen offset:16
; GFX9-O3-NEXT:    s_endpgm
